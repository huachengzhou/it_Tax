        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="red">欢迎您，${user.name}&nbsp;</font></a><!-- 显示用户名 -->
                    </td>
                    ...
                    <td align="left" valign="middle" ><a href="${ctx}/logoutUser">退出</a></td>
                </tr>
            </table>
        </td>
    </tr>
...
<div class="menu">
    <ul class="clearfix">
        ...
        <li><a href="${ctx}/nsfw/nsfwHome">纳税服务</a> </li>
            ...
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                        	<!-- user中的头像处理,如果已经登陆则显示头像 -->
                        	<img alt="图片崩溃" src="${user.imgSrc}" width="90" height="90">
                        </div>
                    </td>
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;">${user.name}</td>
                        </tr>
                        <tr>
        ...
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                ...
                <div style="float:right;padding-top:3px;">
                	<a href="sysComplainAddUI" target="_blank" accesskey="">我要投诉</a>&nbsp;&nbsp;
                </div>
            </div>
            <table width="98%" border="0" align="center">
