...
<head>
    ...
    <script src="${ctx}/js/jquery/jquery-1.8.0.js" type="text/javascript"></script>
...
<div class="xzfw" style="width: 210px;">
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
				<dl class="">
                    <dt><a class="yh" href="showListRole" target="mainFrame"><b></b>角色管理<s class="down"></s>
                    </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="yh" href="showListUser" target="mainFrame"><b></b>用户管理<s class="down"></s>
                    </a></dt>
                </dl>

                <dl>
                    <dt><a class="xxfb" href="showInfoList" target="mainFrame"><b></b>信息发布管理<s
                            class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="tssl" href="showComplainList" target="mainFrame"><b></b>投诉受理管理<s
                            class="down"></s> </a></dt>
                </dl>
                <dl class="">
